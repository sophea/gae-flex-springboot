...
public class CategoryDaoImpl implements CategoryDao {
    ...
    public ResponseList<DCategory> getPage(int pagesize, String offset) {
        ...
        List<DCategory> list = this.jdbcTemplate.query(sql,new CategoryMapper());
    ...
    public DCategory get(Long id) {
        ...
        try {
            //select for object
            final DCategory obj = jdbcTemplate.queryForObject(sql, new Object[] { id }, new CategoryMapper());
            return obj;
    ...
    public final class CategoryMapper implements RowMapper<DCategory> {

        @Override
        public DCategory mapRow(ResultSet rs, int index) throws SQLException {
